        ...
        <div className="@xl:grid-cols-2 mt-12 grid gap-3 *:p-6">
          <Card variant="mixed" className="row-span-2 grid grid-rows-subgrid">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">
                Not just one language. Build real projects with multiple
                languages.
              </p>
            </div>
            <div
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm">
                Multiple users can edit the same file together with instant
                updates.
              </p>
            </div>
          ...
          <Card variant="mixed" className="row-span-2 grid grid-rows-subgrid">
            <div className="space-y-2">
              <h3 className="font-medium">Secure & Reliable Sync</h3>
              <p className="text-muted-foreground text-sm">
                No broken state, no missing updates. Collaboration stays
                consistent.
              </p>
            </div>
